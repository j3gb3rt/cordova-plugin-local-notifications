...
[![npm version](https://badge.fury.io/js/j3gb3rt-cordova-plugin-local-notifications.svg)](https://badge.fury.io/js/j3gb3rt-cordova-plugin-local-notifications)
...
This is a fork to make a 0.8.6 release which includes Android O support

This fork will not be kept up to date
